...
table_id = 'stg_film_actor' # Modify the necessary table name: stg_film, stg_city etc.
...
with base as (
  select *
  from `hip-weaver-479921-q2.pagila_productionpublic.film_actor` --Your table path
  )
